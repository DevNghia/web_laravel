    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('public/frontend/images/3.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('public/frontend/images/1.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('public/frontend/images/2.png')}}"></span>
                                <span class="subject">
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="public/frontend/js/flot-chart/excanvas.min.js"></script><![endif]-->
